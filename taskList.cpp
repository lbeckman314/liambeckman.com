...
int taskList::readInFile(taskStruct Task[])
{
    ifstream inFile;
...
void taskList::addTask(taskStruct Task[], int &numberOfTasks)
{
    cin.ignore(100, '\n');
    cout << "enter name: ";
...
void taskList::findTask(taskStruct Task[], char search[])
{
	cout << "findTask()" << endl;
...
void taskList::printAllTasks(taskStruct Task[], int numberOfTasks)
{
    cout << "\n----------TASKS-----------" << endl;
...
void taskList::printSchedule(taskStruct Task[], int numberOfTasks)
{
    int currentMonth = 0;	
    int currentDay = 0;   
    int currentYear = 0;
...
void taskList::modifyTask(taskStruct Task[], int numberOfTasks)
{
    int modifyChoice = 0;
